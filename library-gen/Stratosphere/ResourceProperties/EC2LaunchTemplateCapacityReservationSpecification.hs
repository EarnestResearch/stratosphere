...
import Stratosphere.ResourceProperties.EC2LaunchTemplateCapacityReservationPreference
...
data EC2LaunchTemplateCapacityReservationSpecification =
  ...
  { _eC2LaunchTemplateCapacityReservationSpecificationCapacityReservationPreference :: Maybe EC2LaunchTemplateCapacityReservationPreference
...
instance FromJSON EC2LaunchTemplateCapacityReservationSpecification where
  parseJSON (Object obj) =
    EC2LaunchTemplateCapacityReservationSpecification <$>
      (obj .:? "CapacityReservationPreference") <*>
...
ecltcrsCapacityReservationPreference :: Lens' EC2LaunchTemplateCapacityReservationSpecification (Maybe EC2LaunchTemplateCapacityReservationPreference)
