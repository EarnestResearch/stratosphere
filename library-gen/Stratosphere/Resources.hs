...
import Stratosphere.ResourceProperties.EC2LaunchTemplateCapacityReservationPreference as X
...
data ResourceProperties
  ...
  | EC2VPCEndpointServiceProperties EC2VPCEndpointService
...
resourcePropertiesJSON (EC2VPCEndpointServiceProperties x) =
  [ "Type" .= ("AWS::EC2::VPCEndpointService" :: String), "Properties" .= toJSON x]
...
resourceFromJSON n o =
    do type' <- o .: "Type" :: Parser String
       props <- case type' of
         ...
         "AWS::EC2::VPCEndpointService" -> EC2VPCEndpointServiceProperties <$> (o .: "Properties")
